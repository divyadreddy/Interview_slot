...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post interviews_url, params: { interview: { end_time: @interview.end_time, participants_email: @interview.participants_email, start_time: @interview.start_time, title: @interview.title } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { end_time: @interview.end_time, participants_email: @interview.participants_email, start_time: @interview.start_time, title: @interview.title } }
